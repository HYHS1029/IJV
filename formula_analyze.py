...
L = smallPathArr.mean(axis=1).mean(axis=0)- largePathArr.mean(axis=1).mean(axis=0)
Ipmax = smallRefpArr.mean(axis=1).mean(axis=0)
Ipmin = largeRefpArr.mean(axis=1).mean(axis=0)
Lp = smallPathpArr.mean(axis=1).mean(axis=0)- largePathpArr.mean(axis=1).mean(axis=0)
#%%
